        ...
        <div class="container">
            ...
            <nav class="main-navigation">
                ...
                <ul>
                    ...
                    <li <?php if(get_post_type() == 'program' OR is_page('program')) echo 'class=current-menu-item'; ?>><a href="<?php echo get_post_type_archive_link('program'); ?>">Programs</a></li>
                    <li <?php if(get_post_type() == 'event' OR is_page('past-events')) echo 'class=current-menu-item'; ?>><a href="<?php echo get_post_type_archive_link('event'); ?>">Events</a></li>
                    <li <?php if(get_post_type() == 'campus' OR is_page('campus')) echo 'class=current-menu-item'; ?>><a href="<?php echo get_post_type_archive_link('campus'); ?>">Campuses</a></li>
